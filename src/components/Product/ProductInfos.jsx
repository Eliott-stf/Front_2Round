      ...
      <div className="w-full max-w-130 flex flex-col shrink-0">
        ...
        <div className="flex flex-col gap-4 w-full py-10">
          {isOwner ? (
            ...
            <>
              <button className="rounded-2xl w-full h-17 bg-white text-black font-inter font-semibold text-[15px] uppercase tracking-[0.15em] hover:bg-[#e5e5e5] transition-colors">
                Acheter
              </button>
